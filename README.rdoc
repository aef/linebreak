...
You can put strings or objects including a to_s method into the convert method
and optionally define a target linebreak encoding. The default encoding is
:unix. You can also choose :windows and :mac. Notice that the :mac encoding is
...
command:
  ...
  git clone git://github.org/aef/breakverter.git

Help on making this software better is always very appreciated. If you want your
changes to be included in the official release, please send me a patch. You can
generate a patch-file by the following command:
